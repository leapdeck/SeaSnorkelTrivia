            ...
            if (showFeedback)
              Text(
                ...
                style: TextStyle(
                  fontSize: 24 * 0.7 * 1.6,
                  fontWeight: FontWeight.bold,
                  color: feedback == "Correct" ? Colors.green[300] : Colors.orange,
                ),
                textAlign: TextAlign.center,
              ),
            const SizedBox(height: 20),
...
class _Activity3ScreenState extends State<Activity3Screen> {
  ...
  void _selectRandomBackground() {
    ...
    final imageNumber = random.nextInt(8) + 1; // 1 to 8
    backgroundImage = 'assets/snorkelpic$imageNumber.jpg';
  }
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: const Text('SeaSnorkel Topics Menu'),
                ),
              ],
            ),
          ],
...
class _CountrySelectionScreenState extends State<CountrySelectionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Select Snorkeling Area'),
                ...
                return ElevatedButton(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (country == 'Maldives') // Check for the specific category
                        Image.asset(
                          'assets/sealife1.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Maui,\nHawaii') // Check for the specific category
                        Image.asset(
                          'assets/sealife2.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Galapagos Islands,\nPhilippines') // Check for the specific category
                        Image.asset(
                          'assets/sealife3.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Monterey\nCA') // Check for the specific category
                        Image.asset(
                          'assets/sealife4.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Bonaire,\nCaribbean') // Check for the specific category
                        Image.asset(
                          'assets/sealife5.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Palawan,\nPhilippines') // Check for the specific category
                        Image.asset(
                          'assets/sealife6.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Hatteras Island,\nNC') // Check for the specific category
                        Image.asset(
                          'assets/sealife7.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
                      if (country == 'Red Sea,\nEgypt') // Check for the specific category
                        Image.asset(
                          'assets/sealife8.png', // Path to your image
                          height: 50, // Adjust size as needed
                        ),
